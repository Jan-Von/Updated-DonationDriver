...
public class DonationsRejectedView{
    ...
    public DonationsRejectedView() {
        ...
        JLabel deliveryPlace = new JLabel("<html>Damaged <br> Broken Goods</html>");
        ...
        JLabel transitBox = new JLabel("Rejected", SwingConstants.CENTER);
        transitBox.setBounds(480, 20, 100, 35);
        transitBox.setBackground(new Color(255, 153, 153));
        transitBox.setForeground(new Color(153, 0, 0));
        ...
        JLabel deliveryPlace2 = new JLabel("<html>Dirty Item</html>");
        ...
        ImageIcon deliveryicon2 = new ImageIcon("Resources/Images/deliveryIcon.png");
        scaledImg = deliveryicon2.getImage().getScaledInstance(65, 65, Image.SCALE_SMOOTH);
        JLabel deliveryIcon2 = new JLabel(new ImageIcon(scaledImg));
        deliveryIcon2.setBounds(175, 50, 65, 65);
        Notif2Card.add(deliveryIcon2);
        ...
        JLabel transitBox2 = new JLabel("Rejected", SwingConstants.CENTER);
        transitBox2.setBounds(480, 20, 100, 35);
        transitBox2.setBackground(new Color(255, 153, 153));
        transitBox2.setForeground(new Color(153, 0, 0));
