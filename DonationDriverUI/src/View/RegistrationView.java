...
public class RegistrationView {
    ...
    public RegistrationView() {
        ...
        JLabel imageLabel = new JLabel(new ImageIcon(new ImageIcon("logoicon.png").getImage().getScaledInstance(150, 90, Image.SCALE_SMOOTH)));
        imageLabel.setBounds(460, 15, 150, 90);
